...
public class MovingViolationsManagerView {
	...
	public void printReq4C(Heap<InfraccionesViolationCode> resultados) 
	{
		...
		{
			//System.out.println(resultados.delMax().toString());
			InfraccionesViolationCode actual=resultados.delMax();
			System.out.println(actual.getViolationCode()+ " | "+actual.getTotalInfracciones());
		}
	}
